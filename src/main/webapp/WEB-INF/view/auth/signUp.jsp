...
<head>
    ...
    <title>Sign Up - Telegram Web</title>
</head>
<style>
    body {
...
<div class="signup-container">
    <h1>Sign Up for Telegram Web</h1>
    <form action="${pageContext.request.contextPath}/auth/sign-up" method="post">
        ...
        <label>
            <input name="telephoneNumber" type="text" placeholder="telephoneNumber" pattern="\\+998(99|95|71|33|94|88|90)[0-9]{7}$">
        </label>
        <label>
            <input type="password" id = "password" name="password" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{4,}"/>
        </label>
        <label>
            <input type="password" id = "confirm-password" name="confirmPassword" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{4,}"/>
