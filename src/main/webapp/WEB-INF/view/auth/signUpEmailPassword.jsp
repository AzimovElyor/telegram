...
<div class="confirmation-container">
    ...
    <form action="${pageContext.request.contextPath}/auth/sign-up/email/password" method="post">
        <input name = "num1" type="text"  maxlength="1" class="digit-input" pattern="\d" value="">
        <input name = "num2"  type="text" maxlength="1" class="digit-input" pattern="\d" value="" >
        <input name = "num3" type="text" maxlength="1" class="digit-input" pattern="\d" value="">
        <input name = "num4" type="text" maxlength="1" class="digit-input" pattern="\d" value="">
        <input name = "num5" type="text" maxlength="1" class="digit-input" pattern="\d" value="">
        <input  type="hidden" name="password" value=${password}>
        <input  type="hidden" name="email" value=${email}>
        <button type="submit">Confirm</button>
    </form>
    <form action="${pageContext.request.contextPath}/auth/sign-up/email" method="post">
        <input type="hidden" name ="email" value=${email} >
